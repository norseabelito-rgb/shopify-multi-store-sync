...
async function initDb() {
  ...
  // GIN index for orders_detail JSONB queries
  await query(`CREATE INDEX IF NOT EXISTS idx_orders_detail_raw_json_gin
    ON orders_detail USING GIN (raw_json jsonb_path_ops);`);

  // GIN index for customers_detail JSONB queries
  await query(`CREATE INDEX IF NOT EXISTS idx_customers_detail_raw_json_gin
